...
|--------------|------------------------|-------------------|
| 66130500095 | นายชิษณุพงศ์ โฉมทอง | หน้า Score Student (ยังไม่ต้องทำ Min, Max, Mean)<br>หน้า Score Teacher (ยังไม่ต้องทำ Min, Max, Mean)<br>หน้า Start Exam ส่ง ID ออกไป |
| 66130500115 | นายณัฐชนน เจริญเสริมสิริ | หน้า Login เช็คว่ามีใน JSON + ตรวจสอบรหัสผ่าน<br>แจ้งเตือนว่า Email หรือ รหัสผิด<br>เก็บข้อมูลเป็น LocalStorage<br>Nav Bar ดึงข้อมูลจาก LocalStorage + ปุ่ม Logout<br>หน้า Admin สำหรับ Delete/Edit Professor |
